		...
		return (
			<div className="nav-wrapper">
				<div className="settings-nav-wrapper">
					...
					<ul className="menu">
						<li>
							<a className="create-nav home-button" href="#createhouse"><i className="material-icons md-18">keyboard_arrow_right</i>house</a>
						</li>
						<li>
							<a className="home-button" href="#addexpense"><i className="material-icons md-18">keyboard_arrow_right</i>expenses</a>
						</li>
						<li>
							<a className="settings-nav home-button" href="#myprofile"><i className="material-icons md-18">keyboard_arrow_right</i>profile</a>
						</li>
					</ul>
				</div>
